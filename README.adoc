...
image:https://github.com/ursjoss/ref2ris/actions/workflows/github-code-scanning/codeql/badge.svg?branch=main&event=push[CodeQL, link=https://github.com/ursjoss/ref2ris/actions/workflows/github-code-scanning/codeql]
